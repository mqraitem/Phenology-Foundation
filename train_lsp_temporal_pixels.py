...
from lib.models.lsp_temporal_pixels import TemporalPixelModel
...
def main():
	...
	parser.add_argument("--variant", type=str, default="se",
	                   choices=["se", "conv1", "conv3", "transformer"],
	                   help="Temporal block variant: se, conv1, conv3, transformer")
	parser.add_argument("--emb_dim", type=int, default=128,
	                   help="Embedding dimension for band projection")
	parser.add_argument("--n_layers", type=int, default=3,
	                   help="Number of temporal blocks")
	parser.add_argument("--nhead", type=int, default=4,
	                   help="Number of attention heads (transformer variant only)")
