...
def main():
	...
	parser.add_argument("--conv_k", type=int, default=1,
	                   help="Conv2d kernel size after each bilinear upsample (1=pointwise, 3=spatial refinement)")
	...
	model=PrithviSegUpsample(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size, conv_k=args.conv_k, feed_timeloc=args.feed_timeloc)
