...
def LORA_peft(model,Lora_peft_layer_name_pre,Lora_peft_layer_name_suffix,LP_layer_no_start,LP_layer_no_end,r,alpha,include_mlp=True):

    # Attention layers: qkv and proj
    ...
    # MLP layers: fc1 and fc2
    if include_mlp:
        target_modules += [f"{Lora_peft_layer_name_pre}.{i}.mlp.fc1"
                          for i in range(LP_layer_no_start,LP_layer_no_end+1)
                         ] + [
                          f"{Lora_peft_layer_name_pre}.{i}.mlp.fc2"
                          for i in range(LP_layer_no_start,LP_layer_no_end+1)
                         ]
