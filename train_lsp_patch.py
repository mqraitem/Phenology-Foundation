...
def main():
	...
	cache_path_train=f"{path_config.get_pixels_cache_dir()}/{args.data_percentage}_patch-{args.patch_size}.npz"

	cycle_dataset_train=CycleDatasetPatches(path_train,split="training",cache_path=cache_path_train, data_percentage=args.data_percentage, patch_size=(args.patch_size, args.patch_size))
