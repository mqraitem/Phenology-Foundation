...
from lib.utils import print_trainable_parameters
...
def main():
	...
	# Add Mini Prithvi-specific arguments
	parser.add_argument("--use_temporal_only_attn", type=str2bool, default=False,
	                   help="Use temporal-only attention in Mini Prithvi")
