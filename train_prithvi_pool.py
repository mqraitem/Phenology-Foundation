...
from lib.models.prithvi_pool import PrithviSegPool
...
def main():
	...
	parser.add_argument("--pool_type", type=str, default="mean",
	                   ...
	                   help="Temporal pooling strategy (mean, max, attention)")
	...
	model=PrithviSegPool(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size, pool_type=args.pool_type, feed_timeloc=args.feed_timeloc)
