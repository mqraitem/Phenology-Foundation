...
from lib.models.prithvi_cat import PrithviSegCat
...
def main():
	...
	parser.add_argument("--c_per_t", type=int, default=4,
	                   help="Channels per timestep from Prithvi stream after PixelShuffle")
	...
	parser.add_argument("--chunk_size", type=int, default=5000,
	                   help="Chunk size for per-pixel transformer processing")
	...
	model = PrithviSegCat(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size,
	                      c_per_t=args.c_per_t, d_model=args.d_model, nhead=args.nhead,
	                      num_layers=args.num_layers, chunk_size=args.chunk_size, feed_timeloc=args.feed_timeloc)
