...
from lib.models.prithvi_blowup_t import PrithviSegBlowupT
...
def main():
	...
	model=PrithviSegBlowupT(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size, c_per_t=args.c_per_t, d_model=args.d_model, nhead=args.nhead, num_layers=args.num_layers, chunk_size=args.chunk_size, feed_timeloc=args.feed_timeloc)
