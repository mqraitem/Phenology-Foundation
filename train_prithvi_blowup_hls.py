...
from lib.models.prithvi_blowup_hls import PrithviSegBlowupHLS
...
def main():
	...
	parser.add_argument("--n_temporal_layers", type=int, default=4,
	                   help="Number of hidden Conv2d layers in the temporal fusion head")
	parser.add_argument("--n_final_layers", type=int, default=4,
	                   help="Number of 1x1 conv layers after HLS concatenation")
	...
	wandb_config = {
		...
		"n_final_layers": args.n_final_layers,
		"loss": args.loss,
	}
	...
	model=PrithviSegBlowupHLS(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size, c_per_t=args.c_per_t, hidden_dim=args.hidden_dim, n_temporal_layers=args.n_temporal_layers, n_final_layers=args.n_final_layers, feed_timeloc=args.feed_timeloc)
