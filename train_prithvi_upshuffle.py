...
def main():
	...
	model=PrithviSegBlowup(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size, c_per_t=args.c_per_t, hidden_dim=args.hidden_dim, n_temporal_layers=args.n_temporal_layers, feed_timeloc=args.feed_timeloc)
