...
def main():
	...
	parser.add_argument("--proj_dim", type=int, default=512,
	                   help="Projection dimension before upscaling (e.g. 256, 512, 768)")
	...
	model=PrithviSegSimple(config["pretrained_cfg"], weights_path, True, n_classes=4, model_size=args.model_size, proj_dim=args.proj_dim, feed_timeloc=args.feed_timeloc)
